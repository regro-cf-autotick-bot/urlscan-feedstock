...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/urlscan-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11885&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/urlscan-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `urlscan` can be installed with:

```
conda install urlscan
```

It is possible to list all of the versions of `urlscan` available on your platform with:
